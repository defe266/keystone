...
var debug = require('debug')('keystone:fields:fileUpload');

/**
 * File FieldType Constructor
 */
function fileUpload (list, path, options) {
 ...
 */
fileUpload.prototype.addToSchema = function (schema) {
...
/**
 * Uploads a new fileUpload
 */
fileUpload.prototype.upload = function (item, file, callback) {
	var field = this;
 ...
 */
fileUpload.prototype.reset = function (item) {
	var value = {};
	Object.keys(this.storage.schema).forEach(function (path) {
		value[path] = null;
	});
...
fileUpload.prototype.remove = function (item) {
 ...
 */
fileUpload.prototype.format = function (item) {
 ...
 */
fileUpload.prototype.isModified = function (item) {
	var modified = false;
 ...
 */
fileUpload.prototype.validateInput = function (data, callback) {
 ...
 */
fileUpload.prototype.validateRequiredInput = function (item, data, callback) {
 ...
 */
fileUpload.prototype.updateItem = function (item, data, files, callback) {
	// Process arguments
