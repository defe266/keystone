...
export default class BlockComponent extends Component {
  ...
  render() {
    ...
    //<div className="draft-Link__container"></div>
    /*
    var item = Immutable.fromJS({
      "image": "http://ichef.bbci.co.uk/onesport/cps/624/cpsprodpb/13BFB/production/_90719808_prop.jpg",
      "created": "2017-05-16T11:46:23Z",
      "domain": "bbc.co.uk",
      "isvalid": true,
      "originalURL": "http://bbc.in/2aGSDH9",
      "title": "Rio Olympics 2016: Venue worker's marriage proposal to Brazil player accepted",
      "lang": "en",
      "published_date": null,
      "url": "http://www.bbc.co.uk/sport/olympics/37018532",
      "content": "A Rio Olympics venue manager proposes to Brazilian rugby sevens player Isadora Cerullo after the host country's match in Deodoro."
    })*/
        ...
        <div {...elementProps} className={className} >
          ...
          <div className="draft-Link">
            ...
            <div ref="content">
              ...
              <LinkPreview item={Immutable.fromJS(data.data)}/>
